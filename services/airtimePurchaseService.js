...
// const contractAddress = process.env.AirtimePurchase_ADRESS; // Retrieve contract address from .env
...
//     const receipt = await contract.methods.purchaseAirtime().send({ from: accounts[0], value: web3.utils.toWei(amount.toString(), 'ether') });
